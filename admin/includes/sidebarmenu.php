									...
									<ul id="menu" >
									 ...
									 <li id="menu-academico" ><a href="#"><i class="fa fa-product-hunt" aria-hidden="true"></i><span>产品</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										   ...
										   <li id="menu-academico-avaliacoes" ><a href="#">产品管理</a></li>
											<li id="menu-academico-avaliacoes" ><a href="product_sort.php">产品分类设置</a></li>
											<li id="menu-academico-avaliacoes" ><a href="product_list.php">所有产品列表</a></li>
											...
											<li id="menu-academico-avaliacoes" ><a href="manage-packages.php">单项服务</a></li>
											<li id="menu-academico-avaliacoes" ><a href="manage-packages.php">热门产品</a></li>
											<li id="menu-academico-avaliacoes" ><a href="manage-packages.php">特价产品</a></li>
											<li id="menu-academico-avaliacoes" ><a href="manage-packages.php">旅游新品</a></li>
